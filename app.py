...
REGIME_INFO = {
    ...
    "Bearish 🔻": "Tren turun...",
    "Early Recovery 🔄": "Harga di atas EMA20...",
    "Distribution 📉": "Harga di bawah EMA20...",
    "Konsolidasi Tren ↔️": "Trending namun...",
    "Bullish Accumulation 🏗️": "Sideways...",
    "Bearish Accumulation 🧊": "Sideways di bawah...",
    "Sideways Bias Naik ↗️": "Sideways cenderung naik...",
    "Sideways Bias Turun ↘️": "Sideways cenderung turun...",
    "Sideways Choppy 🌊": "Volatilitas tinggi...",
    "Sideways Calm 😴": "Sideways sepi...",
...
if run_btn:
    ...
    st.write("Algoritma kuantitatif + Berita + Backtest Terintegrasi + AI + Grafik Interaktif + Analisis Fundamental Saham.")
    ...
    if st.session_state.get("gemini_api_key"):
        with st.spinner("🧠 AI sedang menganalisis hasil dan riwayat..."):
            # Variabel fundamental sudah didefinisikan di atas
            data_ai = {
                "Saham": ticker_input,
                "Harga": f"{harga_terakhir:,.0f}",
                "Sinyal": signal,
